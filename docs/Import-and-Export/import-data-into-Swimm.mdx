...
**Step 1:** Start by clicking the `New` button in the top right corner of your repo page on Swimm.

![Import to Swimm](../../static/img/Importdata2.png)
...
![Import to Swimm](../../static/img/Importdata1.png)
...
- Click `Repo Import` and select the .md files you wish to import from your repo.
- Follow the import wizard instructions. 
...
*Note:* You must be an admin of the space in Confluence in order to export content from Confluence.

- Log into Confluence and choose the space you want to export.
- Select `Space Settings` on the left side-bar.
...
- Uncheck the `Create Folders and Sub-folders` box.
- Click `Export`.
- Your download will begin automatically, and you'll also receive an email from Notion with a link to download your file(s). 
