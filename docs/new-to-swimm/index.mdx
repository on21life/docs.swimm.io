...
<Link to="https://docs.swimm.io/security">Swimm is SOC 2 and ISO27001 compliant.</Link> Swimm does not modify any of your code and none of your actual code or content is stored on Swimm’s servers, including your GitHub token. All data transferred to and from Swimm’s servers is encrypted during transit..
:::
