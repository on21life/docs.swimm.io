...
## **Playlist**
### 📄 apps/web/src/modules/core/creation-hub/CreationHubModal.vue
```vue
       title: 'Playlist',
```
...
Another option for creating documentation is to start by importing a existing markdown files (from your local machine, your repo, Notion or Confluence) - to be converted to a Swimm doc.
