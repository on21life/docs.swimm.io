...
## **Playlist**
If you want to create a collection of docs for your teammates to go over in a certain order, we suggest that you start with Swimm Playlists. Learn more about <Link href="http://localhost:3000/docs/Features/Swimm-Playlists"> Swimm Playlists.</Link> 
...
## **Code Snippet** 
Start a doc by selecting live code snippets from your codebase in your doc. Learn more about using code snippets here. Learn more about <Link href="https://docs.swimm.io/docs/Features/editor-commands"> code snippets.</Link>

## **Request a Doc**
If there is a doc that you’d like to have written by someone else on your team, you can “request a doc” from them. Learn more about <Link href="https://docs.swimm.io/docs/Features/doc-sharing-editing-and-collaboration"> requesting docs.</Link>
