...
Be sure to check out our Doc and Playlist Creation Hub by clicking the `New` button on your repo page. From there, you can see all the options to start creating new docs.

## Step 1: Pick a way to start creating a doc

<br/>

<div align="center"><img src="../../static/img/create_first_doc_n_1.png" style="width:'50%'"/></div>
...
<div align="center"><img src="../../static/img/create_first_doc_n_2.png" style="width:'50%'"/></div>
...
<div align="center"><img src="../../static/img/Create_First_Doc6.gif" style="width:'50%'"/></div>
...
### 📄 apps/web/src/modules/batch-commit/components/BatchCommitButton.vue
```vue
   if (isSavable.value) {
     const savableCount = savableDrafts.value.length;
     const changesString = pluralize({ word: 'Change', count: savableCount });
     return `Commit ${savableCount} ${changesString}`;
   }
```
