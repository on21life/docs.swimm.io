...
- Swimm **only** chances a custom folder created for documentation ("/.swm")
:::
...
**Aboslutely not.** Swimm will create a folder in your repo to store the documents you create upon first login to the 
...
:::info TL;DR
- Swimm uses read permisisons to verify that docs are in sync
...
During the action operation, the app reads the code to verify that the documentation is up to date. 
...
## Compliance
**We are pleased to share that Swimm is SOC 2 compliant.** <br/>
