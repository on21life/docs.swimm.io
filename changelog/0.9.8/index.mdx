...
## Improvements:
- **Creating Docs in Playlists** - You can create new documentation for your Playlists inside an existing Playlist. To add a new step to your Playlist, select a blank doc or another option as usual to create a new doc.
- **PR Comments in GitHub Appt** - When a new PR comment is added by Swimm related to outdated or Auto-synced content, previous Swimm comments in the PR are automatically hidden. 
...
- **Improved Playlist Creation Experience** - Rather than having to create documentation first and then add them to your Playlist, you can now create docs from within the Playlists without needing to switch contexts. When you add a step to your Playlist, select `Blank doc` or another option to start building your dream Playlist.
